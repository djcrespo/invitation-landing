<template>
  <div class="grid md:grid-cols-1 lg:grid-cols-2 lg:gap-5">
      ...
      <div class="w-full">
        ...
        <div class="py-5 grid grid-cols-1 lg:grid-cols-2">
          <div class="w-full px-4 text-center">
            <p class="gidole-regular te">Fecha: 26 de diciembre del 2025</p>
            <p class="gidole-regular">Hora: 9:00 P.M.</p>
          </div>
          <div class="w-full px-4 text-center">
            <p class="gidole-regular">Lugar: Villa Gabriela, calle 24 entre 21-A y 23, Caucel.</p>
          </div>
        </div>
        <div class="w-full py-2 flex items-center justify-center">
            <button
              class="boda-verde text-white py-2 px-4 rounded-full gidole-regular outfit text-xl"
              @click="crearCita"
            >
              Agendar
            </button>
    ...
    <div class="w-full card">
      ...
      <iframe
        class="lg:w-full lg:h-[700px] w-full h-[400px]"
